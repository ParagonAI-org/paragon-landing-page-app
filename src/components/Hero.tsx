...
const Hero = async () => {
  ...
  return (
    <section className="relative z-10 px-8 pt-48 pb-20 max-w-[1200px] mx-auto w-full flex flex-row justify-between h-full">
      {/* Left Content */}
      <div className="max-w-2xl flex flex-col justify-between h-full py-10">
        <div>
