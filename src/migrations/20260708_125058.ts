...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_posts_category" AS ENUM('insights', 'product-updates', 'engineering', 'research', 'company', 'student-success', 'safety', 'announcements');
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "research_tags" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_help_articles_fk";
  ...
  DROP INDEX "payload_locked_documents_rels_help_articles_id_idx";
